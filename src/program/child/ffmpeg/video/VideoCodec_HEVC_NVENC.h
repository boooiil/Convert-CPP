#ifndef VIDEO_CODEC_HEVC_NVENC_H
#define VIDEO_CODEC_HEVC_NVENC_H

#include "BaseVideoCodec.h"

class VideoCodec_HEVC_NVENC : public BaseVideoCodec {
public:
  VideoCodec_HEVC_NVENC(std::string runningPreset = "high_quality",
  ...
  auto getName() -> std::string override { return "hevc_nvenc"; }
  auto getAliases() -> std::set<std::string> override {
    return {"hevc_nvenc", "nvenc_hevc", "nvidia_hevc", "hevc_nvidia"};
  }
