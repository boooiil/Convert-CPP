...
public:
  VideoCodec_H264_NVENC(std::string runningPreset = "high_quality",
  ...
  auto getName() -> std::string override { return "h264_nvenc"; }
  auto getAliases() -> std::set<std::string> override {
    return {"h264_nvenc", "nvenc_h264", "nvidia_h264", "h264_nvidia"};
  }
